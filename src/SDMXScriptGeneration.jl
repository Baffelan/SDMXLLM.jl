"""
Tidier.jl Script Generation System for SDMX.jl
...
# Generated by SDMX.jl on {{TIMESTAMP}}
# Source: {{SOURCE_FILE}}
...
function post_process_generated_code(code::String, template::ScriptTemplate, 
    ...
    if !occursin("Generated by SDMX.jl", processed_code)
        header_comment = "# Generated by SDMX.jl on $(now())\n# Template: $(template.template_name)\n\n"
