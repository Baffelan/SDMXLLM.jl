...
Extension package for SDMX.jl that provides LLM-powered data transformation and mapping capabilities. Automatically analyze data structures, infer column mappings, and generate transformation scripts for SDMX (Statistical Data and Metadata eXchange) compliance.

## Requirements

- Julia 1.11 or higher
- SDMX.jl package (automatically installed as dependency)
...
```julia
using Pkg
# Install SDMXLLM.jl (SDMX.jl will be installed automatically)
Pkg.add(url="https://github.com/Baffelan/SDMXLLM.jl")
```
...
- [SDMX.jl](https://github.com/Baffelan/SDMX.jl) - Core SDMX processing functionality
